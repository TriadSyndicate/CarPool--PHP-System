...
<section class="header9 cid-ruv4FB75N7 mbr-fullscreen mbr-parallax-background" id="header9-1">
    ...
    <div style="background-color:rgba(0, 0, 0, 0.5);" class="container">
        <div class="media-container-column mbr-white col-lg-8 col-md-10">
            <h1 class="mbr-section-title align-left mbr-bold pb-3 mbr-fonts-style display-1">Account Successfully Created</h1>

            <p class="mbr-text align-left pb-3 mbr-fonts-style display-5">
              To Activate your Account. Kindly Login.
            </p>
            <div class="mbr-section-btn align-left"><a class="btn btn-md btn-primary display-4" href="login.php">Login</a></div>
        </div>
    </div>
</section>
