          ...
          <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
            ...
            <li class="nav-item dropdown open">
                  ...
                  <div class="dropdown-menu">
                    <!--<a class="text-white dropdown-item display-4" href="https://mobirise.co">New Item</a>-->
                    <a class="text-white dropdown-item display-4" href="userhistory.php">Booking History</a>
